    ...
    return (
        <div id="navbar" className="container bg-light mt-4 rounded">
          <Navbar collapseOnSelect expand="lg">
            <Container>
            <NavLink to="/home" className="text-decoration-none"><Navbar.Brand href="#home"><span className="font-semibold text-green-800 text-3xl">Travel</span><span className="font-semibold text-blue-600 text-3xl">Booking</span></Navbar.Brand></NavLink>
